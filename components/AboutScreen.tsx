...
const AboutScreen = forwardRef<HTMLDivElement, { visibleItems: Set<string> }>(
	(props, ref) => {
			...
			<section className="container" ref={ref}>
				...
				<header className="about-title">
					<ObserverItem key={0} visible={visibleItems.has(`ID-0`)}>
						<h1 className="header" data-id="ID-0" style={{ fontSize: "4em" }}>
							ABOUT
						</h1>
					</ObserverItem>
				</header>
							...
							<div className="item" data-id={`ID-1`}>
								<div className="flip">
									...
									<div className="back back1">
										...
										<p>
											name:{" "}
											<span style={{ fontFamily: "Koreail-Light" }}>
												박희태
											</span>
										</p>
										<p>
